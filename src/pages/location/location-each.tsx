...
//                     (coord) =>
//                       coord.lat !== userCoordinates.lat ||
//                       coord.lng !== userCoordinates.lng,
//                   );
...
//     mutationFn: (data: IForm) => postPlace(data, roomId!),
//     onSuccess: () => {
//       switch (from) {
...
//             const userCoords = {
//               lat: myPlace.addressLat,
//               lng: myPlace.addressLong,
//             };
...
//             className="flex flex-col gap-6 py-1 mb-6"
//           >
//             <div className="flex flex-col w-full gap-3">
//               <div className="flex flex-col items-center gap-2 my-4">
//                 <Parasol />
//                 <span className="text-2xl font-semibold text-[#1A3C95] ml-2">
//                   내 정보 입력
//                 </span>
//               </div>
...
//                 <input
//                   type="hidden"
//                   {...register('roadNameAddress', { required: true })}
//                 />
//               </div>
//             </div>
//           </form>
