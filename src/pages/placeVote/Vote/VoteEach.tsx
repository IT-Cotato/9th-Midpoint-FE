...
// import { FROM_EACH_PLACE_VOTE, ROOM_TYPE_EACH } from '@/constants';
...
//         const candidates: PlaceCandidate[] = data.data.placeCandidates.map(
//           (candidate: any) => ({
//             id: candidate.id,
//             name: candidate.name,
//             siDo: candidate.siDo,
...
//             (candidate) => candidate.id === data.data.voteItem,
//           );
...
//           state: { from: FROM_EACH_PLACE_VOTE },
//         });
...
//     const selectedCandidate = placeCandidates.find(
...
//                 className={`w-full cursor-pointer flex justify-center items-center  rounded-lg py-3 text-lg border ${
//                   selectedPlaceId === candidate.id
//                     ? 'bg-[#EFF3FF] ring-2 ring-[#5786FF] text-[#2F5FDD]'
//                     : 'bg-white'
//                 }`}
//               >
//                 {candidate.name}
