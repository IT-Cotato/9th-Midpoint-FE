...
//     navigate(
//       `/page/e/results/${roomId}/recommendations?lat=${lat}&lng=${lng}&name=${encodeURIComponent(name)}`,
//     );
//   }
...
//         {midPoints.map(
//           ({ name, siDo, siGunGu, addressLat, addressLong }, index) => (
//             <div
//               key={index}
